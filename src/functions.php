...
{
    return aphets_htmlHelper( $aphet_url, "<link rel='stylesheet' href='%s' >\n", $name );
}
   
function aphet_script($aphet_url, $name = null )
{
    return aphets_htmlHelper($aphet_url, "<script src='%s'></script>\n", $name);
}   
